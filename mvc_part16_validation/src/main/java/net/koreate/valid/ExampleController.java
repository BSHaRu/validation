...
public class ExampleController {
    ...
    public ExampleController() {
        this.messageService = NurigoApp.INSTANCE.initialize("api key", "api secrit pw", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setText("테스트 문자 입니다. 주위에 계신분들은 제발 저를 살려주시길 바라겠습니다.");
